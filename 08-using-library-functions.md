...
### Your StudySite Lab — Round and Cap the Grade
...
3. Click **Load from GitHub**, select
   **COSC1436xxx-Grade-Calculator-YourLastName**, and click each source,
...
- **COSC1436xxx-Grade-Calculator-YourLastName** contains the Chapter 8
  checkpoint.
