...
local-development instructions for the required AddressSanitizer checks (both
Step 1's disposable-copy exercise and Step 7's final confirmation), then
...
- **COSC1437xxx-Grade-Calculator-YourLastName** contains the Chapter 22
  checkpoint.
