...
and rebuild after each step — don't wait until the end to test. All of it
goes after `runTests()` and before `main()`.
...
2. Work through Steps 1–4 above in your local editor, in order. After Steps
   1–3 (once you have the comparators, `selectionSort`, and both search
   functions in place), rebuild even though `main` hasn't changed yet — the
